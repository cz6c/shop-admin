...
// 获取信息
export const getRoleInfoApi = createGet<{ id: string }, RoleItem>("/admin/role/info");
// 新增
...
// 状态切换
export const statusChangeApi = createPost<{ id: string; status: 0 | 1 }, unknown>("/admin/role/status");
// 删除
export const delRoleApi = createPost<{ id: string }, unknown>("/admin/role/del");
